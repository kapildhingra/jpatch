...
public class JPatchManagerBU
{
//	private static Logger logger = LoggerFactory.getLogger(JPatchManagerBU.class);
//	
...
//	        JPatchManagerBU.prepareDir(outputDir, false);
//			File patchFile = new File(outputDir.getAbsolutePath() + "/" + JPatchManagerBU.PATCH_FILE_NAME);
//			File patchFilesDir = new File(outputDir.getAbsolutePath() + "/" + JPatchManagerBU.PATCH_FILES_DIR_NAME);
//			
//			patchDocument = this.createDirectoryPatch(oldStateRootDir, "/", newStateRootDir, "/", patchFilesDir, patchDocument);
//			JPatchManagerBU.writeDocumentToFile(patchDocument, patchFile);
//			
...
//				if(JPatchManagerBU.forceMakeDirectory(outputDir))
//				{
...
//                    
//					Map<String, List<File>> categorizedFileMap = JPatchManagerBU.categorizeFiles(newStateDir.listFiles());
//					if(categorizedFileMap != null)
//					{
//                        newStateFileList = categorizedFileMap.get(JPatchManagerBU.FILE_LIST_KEY);
//                        newStateSubDirList = categorizedFileMap.get(JPatchManagerBU.DIR_LIST_KEY);
//					}
//					
...
//                        {
//                            if(JPatchManagerBU.forceCopyFileToDirectory(newStateFile, outputDir))
//                            {
...
//                            {
//                                File outputDir = new File(patchFilesRootDir.getAbsolutePath() + File.separator + newStateRelDirPath);
//                                if(JPatchManagerBU.forceCopyFileToDirectory(newStateFileList.get(newStateFileIndex), outputDir))
//                                {
...
//                                    {
//                                        File outputDir = new File(patchFilesRootDir.getAbsolutePath() + File.separator + newStateRelDirPath);
//                                        JPatchManagerBU.forceCopyFileToDirectory(newStateFileList.get(newStateFileIndex), outputDir);
//
...
//            {
//            	JPatchManagerBU.addPathElement(
//            			patchDocument, 
//            			ELEMENT_PATCH + "/" + ELEMENT_ADDED_DIRECTORIES, 
//            			ELEMENT_DIRECTORY, 
//            			ATTRIBUTE_PATH, 
//            			JPatchManagerBU.getRelativePath(addedDir.getAbsolutePath(), patchFilesRootDir.getAbsolutePath()) + "/");
//            }
//			
...
//            			ELEMENT_DIRECTORY, 
//            			ATTRIBUTE_PATH, 
//            			JPatchManagerBU.getRelativePath(removedDir.getAbsolutePath(), oldStateRootDir.getAbsolutePath()) + "/", 
...
//            			ELEMENT_FILE, 
//            			ATTRIBUTE_PATH, 
//            			JPatchManagerBU.getRelativePath(addedFile.getAbsolutePath(), patchFilesRootDir.getAbsolutePath()));
//            }
//			
...
//            			ELEMENT_FILE, 
//            			ATTRIBUTE_PATH, 
//            			JPatchManagerBU.getRelativePath(updatedFileTuple.getFile().getAbsolutePath(), patchFilesRootDir.getAbsolutePath()), 
...
//            			ELEMENT_FILE, 
//            			ATTRIBUTE_PATH, 
//            			JPatchManagerBU.getRelativePath(removedFile.getAbsolutePath(), oldStateRootDir.getAbsolutePath()), 
...
//		try
//		{
//			JPatchManagerBU.prepareDir(tempDir, true);
...
//		try
//		{
//			File patchFile = new File(patchRootDir.getAbsolutePath() + "/" + JPatchManagerBU.PATCH_FILE_NAME);
//			File patchFilesDir = new File(patchRootDir.getAbsolutePath() + "/" + JPatchManagerBU.PATCH_FILES_DIR_NAME);
//			File rollbackPatchFile = null;
//			File rollbackPatchFilesDir = null;
//			
//			if(rollbackPatchRootDir != null)
//			{
//				rollbackPatchFile = new File(rollbackPatchRootDir.getAbsolutePath() + "/" + JPatchManagerBU.PATCH_FILE_NAME);
//				rollbackPatchFilesDir = new File(rollbackPatchRootDir.getAbsolutePath() + "/" + JPatchManagerBU.PATCH_FILES_DIR_NAME);
//				
//				//if rollback is required, but cannot be prepared, doesnt make sense to go on (catching IOException at bottom)
//				JPatchManagerBU.prepareDir(rollbackPatchRootDir, true);
//				JPatchManagerBU.prepareDir(rollbackPatchFilesDir, true);
//			}
//			
...
//		            			ELEMENT_FILE, 
//		            			ATTRIBUTE_PATH, 
//		            			JPatchManagerBU.getRelativePath(addedRollbackFile.getAbsolutePath(), targetRootDir.getAbsolutePath()));
//		            }
//					
...
//		            			ELEMENT_FILE, 
//		            			ATTRIBUTE_PATH, 
//		            			JPatchManagerBU.getRelativePath(updatedRollbackFile.getAbsolutePath(), targetRootDir.getAbsolutePath()), 
...
//		            			ELEMENT_DIRECTORY, 
//		            			ATTRIBUTE_PATH, 
//		            			JPatchManagerBU.getRelativePath(addedRollbackDir.getAbsolutePath(), targetRootDir.getAbsolutePath()));
//		            }
//					
...
//		            			ELEMENT_FILE, 
//		            			ATTRIBUTE_PATH, 
//		            			JPatchManagerBU.getRelativePath(removedRollbackFile.getAbsolutePath(), targetRootDir.getAbsolutePath()), 
...
//		            			ELEMENT_DIRECTORY, 
//		            			ATTRIBUTE_PATH, 
//		            			JPatchManagerBU.getRelativePath(removedRollbackDir.getAbsolutePath(), targetRootDir.getAbsolutePath()), 
//		            			removedRollbackDir.lastModified());
//		            }					
//					
//					JPatchManagerBU.writeDocumentToFile(rollbackPatchDocument, rollbackPatchFile);
//				}
//			}
//		}
//		catch(Exception e)
...
//	            }
//	        }
//            categorizedMap.put(JPatchManagerBU.FILE_LIST_KEY, fileList);
//            categorizedMap.put(JPatchManagerBU.DIR_LIST_KEY, directoryList);
//	    }
